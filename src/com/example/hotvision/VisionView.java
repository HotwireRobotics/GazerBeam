...
public class VisionView extends JavaCameraView implements PictureCallback {
    ...
    public void SetCamSettings()
    {
        ...
        camParams.setExposureCompensation(-12);
        
        // white balance
        camParams.setAutoWhiteBalanceLock(false);
        
        mCamera.setParameters(camParams);
        Log.i(TAG, "Camera parameters set.");
    }
